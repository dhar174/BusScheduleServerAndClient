...
public class Routes
{
    ...
    public void populate_Arrival_times_by_route(int id)
    {
        ...
        this.Arrival_times = new LinkedList<String>(dates as IEnumerable<String>);
    ...
    public LinkedList<String>? Arrival_times { get; set; } = new LinkedList<String>();
...
public class Stops
{
    ...
    public Stops(int id, int order)
    {
        ...
        this.next_Arrival_time = this.Arrival_times.First.Value;
        this.id = id;
        this.order = order;
    }
